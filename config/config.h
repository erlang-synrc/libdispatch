...
/* Define to 1 if you have the declaration of `EVFILT_MACHPORT', and to 0 if
   you don't. */
#define HAVE_DECL_EVFILT_MACHPORT 0

/* Define to 1 if you have the declaration of `FD_COPY', and to 0 if you
   don't. */
#define HAVE_DECL_FD_COPY 0

/* Define to 1 if you have the declaration of `F_RDADVISE', and to 0 if you
   don't. */
#define HAVE_DECL_F_RDADVISE 0
...
/* Define to 1 if you have the declaration of `O_SYMLINK', and to 0 if you
   don't. */
#define HAVE_DECL_O_SYMLINK 0
...
/* Define if libobjc implements blocks runtime */
#define HAVE_OBJC_BLOCKS_RUNTIME 1

/* Define if sem_t can cast to uintptr_t */
/* #undef HAVE_POSIX_SEM_UINTPTR_T */
